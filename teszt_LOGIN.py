...
def sign_in():
    ...
    # user_profile = browser.find_element_by_xpath('//a[@href="#/@+f\'{random_name}\'+/" and @class="nav-link"]')
    print(user_profile.text)

    try:
        assert user_profile.text == random_name  #  user1["name"]  helyes felhasználónév megjelenítésének ellenőrzése
